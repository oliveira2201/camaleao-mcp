// Teste: Buscar dados reais da semana via API
...
async function buscarDadosSemana() {
  console.log('═══════════════════════════════════════════');
  console.log('TESTE: Dados da semana via API');
  console.log('═══════════════════════════════════════════\n');
  ...
  // 2. Buscar entradas (primeiras 3 páginas para ter certeza)
  ...
  const dataInicio = fmt(segundaFeira);
  const dataFim = fmt(hoje);

  console.log(`📅 Período: ${dataInicio} (segunda) a ${dataFim} (hoje)`);
  console.log('');
...
buscarDadosSemana().catch(console.error);
